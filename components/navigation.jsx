          ...
          {isLoggedIn ? (
            <>
              <div className="inline-flex justify-start mx-8 items-center text-textSecondary fill-textSecondary text-xl">
                <a className="hover:cursor-pointer hover:bg-secondaryAccent p-2 rounded-posts">
            ...
            <div className="justify-start mx-8 items-center">
              <Link href="/">
                <button className="text-xs bg-backgroundAccent px-6 py-2 text-white font-nunito font-semibold rounded-buttons">
                  Anmelden
                </button>
              </Link>
            </div>
